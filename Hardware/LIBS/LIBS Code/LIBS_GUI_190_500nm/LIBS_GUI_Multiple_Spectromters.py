...
qtcreator_file  = "LIBS_GUI_Multiple_Spectromters.ui" # Enter file here.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def start_raster(self):
        ...
        self.step_count = 1
        self.print_location()
        message = "number of Steps Taken: " + str(self.step_count)
    ...
    def DisconnectAll(self):
        ...
        self.reset(spectrometer1) # close stellarNet
        self.reset(spectrometer2) # close stellarNet
    ...
    def raster_inp(self, inp):
        ...
        self.total_shots.setText(str(self.num_shots_same_loc*self.num_shots))
